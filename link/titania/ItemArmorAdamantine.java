...
public class ItemArmorAdamantine extends ItemArmor
{
	...
	public ItemArmorAdamantine(int par1,
	...
	public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if(player.getCurrentItemOrArmor(4) != null && player.getCurrentItemOrArmor(3) != null && player.getCurrentItemOrArmor(2) != null && player.getCurrentItemOrArmor(1) != null)
		{
			 ...
			 if (helmet.getItem() == MainMod.adamantineHelm && plate.getItem() == MainMod.adamantineChest && legs.getItem() == MainMod.adamantineLegs && boots.getItem() == MainMod.adamantineBoots) 
			 {

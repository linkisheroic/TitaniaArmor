...
public class ItemArmorSea extends ItemArmor
{

	public ItemArmorSea(int par1, EnumArmorMaterial par2EnumArmorMaterial,
			int par3, int par4) {
	...
	public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if(player.getCurrentItemOrArmor(4) != null && player.getCurrentItemOrArmor(3) != null && player.getCurrentItemOrArmor(2) != null && player.getCurrentItemOrArmor(1) != null)
		{
			 ...
			 if (helmet.getItem() == MainMod.seaHelm && plate.getItem() == MainMod.seaChest && legs.getItem() == MainMod.seaSkirt && boots.getItem() == MainMod.seaBoots) 
			 {

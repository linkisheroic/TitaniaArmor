...
public class ItemArmorTitania extends ItemArmor
{
	public ItemArmorTitania(int par1, EnumArmorMaterial par2EnumArmorMaterial,
			int par3, int par4) {
	...
	public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if(player.getCurrentItemOrArmor(4) == null && player.getCurrentItemOrArmor(3) != null && player.getCurrentItemOrArmor(2) != null && player.getCurrentItemOrArmor(1) != null)
		{
			 ...
			 if (plate.getItem() == MainMod.titaniaChest && legs.getItem() == MainMod.titaniaSkirt && boots.getItem() == MainMod.titaniaBoots) 
			 {

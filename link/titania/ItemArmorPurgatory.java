...
public class ItemArmorPurgatory extends ItemArmor
{

	public ItemArmorPurgatory(int par1,
	...
	public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack itemStack) {
		...
		if(player.getCurrentItemOrArmor(4) != null && player.getCurrentItemOrArmor(3) != null && player.getCurrentItemOrArmor(2) != null && player.getCurrentItemOrArmor(1) != null)
		{
			 ...
			 if (helmet.getItem() == MainMod.purgatoryHead && plate.getItem() == MainMod.purgatoryChest && legs.getItem() == MainMod.purgatoryLegs && boots.getItem() == MainMod.purgatoryBoots) 
			 {
